...
public class ReadInput implements Serializable 
{
    ...
    public int getStartingNumMosquitos() { return startingNumMosquitos; }
    ...
    //====================================================
    public ReadInput(String file, String rootDir)
    {
    ...
    //====================================================
    public void getInputFileContent(Extensions ext)
    {
        System.out.println ("Get the input file content");
        try{
            // Open the file that is the first command line parameter
            ...
            while ((strLine = br.readLine()) != null)   {
                ...
                ext.inputFileContent.add(strLine);
            }
            //Close the input stream
            in.close();
        }catch (Exception e){//Catch exception if any
